...
- **Persistent Storage:** Since source directories are mounted into the Docker container, code modified inside the container or on the Pi's host OS directly syncs without losing changes across restarts.
...
Bash
git clone [https://github.com/](https://github.com/)<your-username>/my_nav_pkg.git
