...
def launch_setup(context):
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file', default_value=os.path.join(get_package_share_directory('my_nav_pkg'), 'config/my_nav_params.yaml')
    )
    ...
    load_collision_monitor = LoadComposableNodes(
